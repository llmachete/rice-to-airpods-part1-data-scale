...
// Interactive elements (keep these)
...
export default function ArticlePage() {
  ...
  // Track overall page scroll progress for top nav bar
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <main className="pt-20 bg-slate-50">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Section 1.1: Why Physical Analogies Matter */}
        <section className="mb-12">
        ...
        {/* Callout Box */}
        <div className="my-16 p-8 bg-slate-100 rounded-lg border-l-4 border-slate-900">
          <p className="text-lg text-slate-700 italic">
            You just went from a coffee cup to a shipping container. That's a 1,000,000× increase in volume.
            A 128 GB iPhone contains the equivalent of 128 shipping containers worth of rice grains.
        ...
        {/* Section 5: The Scale Shift Nobody Prepared Us For */}
        <section className="mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-slate-700 leading-relaxed">
            This acceleration from kilobytes in the 1980s to zettabytes today wasn't linear. Wasn't gradual.
            It was exponential. And most of that growth happened in the last decade.
          </p>
        </section>
        ...
        <section className="mb-12 p-8 bg-slate-800 rounded-lg border border-slate-700">
        ...
        {/* Interactive: Napster Time Machine */}
        <div className="my-16">
